...
use crate::module_explorer::{
    format_function_url, ModuleData, FUNCTION_ITEM_LABEL_START, STORAGE_ITEM_LABEL_START,
    STRUCT_ITEM_LABEL_START, UNIFORM_ITEM_LABEL_START, WORKGROUP_ITEM_LABEL_START,
};
