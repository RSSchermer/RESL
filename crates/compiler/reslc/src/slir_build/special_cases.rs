...
fn define_usize_slice_index_get(instance: Instance, cx: &CodegenContext) {
    ...
    // let some_variant_ty = module.ty.register(TypeKind::Struct(option_enum.variants[1]));
    ...
    // let predicate = body
    //     .local_values
    //     .insert(LocalValueData::predicate());
    // let elem_ptr = body
    //     .local_values
    //     .insert(LocalValueData { ty: Some(elem_ptr_ty) });
    // let some_ptr = body
    //     .local_values
    //     .insert(LocalValueData { ty: Some(some_variant_ptr_ty) });
    // let payload_ptr = body
    //     .local_values
    //     .insert(LocalValueData { ty: Some(elem_ptr_ty) });
    //
    ...
    //
    // body.basic_blocks[bb0].statements.push(OpBinary {
    ...
    // body.basic_blocks[bb1].statements.push(OpSetDiscriminant {
    //     ptr: ret.into(),
    //     variant_index: 1,
    // }.into());
    // body.basic_blocks[bb1].statements.push(OpPtrVariantPtr {
    //     ptr: ret.into(),
    //     variant_index: 1,
    //     result: some_ptr,
    // }.into());
    // body.basic_blocks[bb1].statements.push(OpPtrElementPtr {
    ...
    //     result: elem_ptr,
    // }.into());
    // body.basic_blocks[bb1].statements.push(OpStore {
    //     ptr: some_ptr.into(),
    //     value: elem_ptr.into(),
    // }.into());
