rislc_monomorphize_abi_error_disabled_vector_type =
...
rislc_monomorphize_abi_error_unsupported_unsized_parameter =
  this function {$is_call ->
    [true] call
    *[false] definition
...
rislc_monomorphize_abi_error_unsupported_vector_type =
  this function {$is_call ->
    [true] call
    *[false] definition
...
rislc_monomorphize_abi_required_target_feature =
  this function {$is_call ->
    [true] call
    *[false] definition
...
rislc_monomorphize_couldnt_dump_mono_stats =
...
rislc_monomorphize_encountered_error_while_instantiating_global_asm =
    the above error was encountered while instantiating `global_asm`

rislc_monomorphize_large_assignments =
    moving {$size} bytes
...
rislc_monomorphize_start_not_found = using `fn main` requires the standard library
    .help = use `#![no_main]` to bypass the Rust generated entrypoint and declare a platform specific entrypoint yourself, usually with `#[no_mangle]`

rislc_monomorphize_symbol_already_defined = symbol `{$symbol}` is already defined