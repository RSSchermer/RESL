...
#[diag(rislc_monomorphize_large_assignments)]
#[note]
...
#[derive(Diagnostic)]
#[diag(rislc_monomorphize_symbol_already_defined)]
...
#[derive(Diagnostic)]
#[diag(rislc_monomorphize_couldnt_dump_mono_stats)]
...
#[derive(Diagnostic)]
#[diag(rislc_monomorphize_encountered_error_while_instantiating_global_asm)]
...
#[derive(Diagnostic)]
#[diag(rislc_monomorphize_start_not_found)]
#[help]
pub(crate) struct StartNotFound;

#[derive(Diagnostic)]
#[diag(rislc_monomorphize_abi_error_disabled_vector_type)]
#[help]
...
#[derive(Diagnostic)]
#[diag(rislc_monomorphize_abi_error_unsupported_unsized_parameter)]
#[help]
...
#[derive(Diagnostic)]
#[diag(rislc_monomorphize_abi_error_unsupported_vector_type)]
...
#[derive(Diagnostic)]
#[diag(rislc_monomorphize_abi_required_target_feature)]
#[help]
